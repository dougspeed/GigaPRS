...
GigaPRS_Step2=function(bedstem=NULL, pgenstem=NULL, scores=NULL, multiscores=NULL,outstem=NULL,allowMissing=FALSE,extractfile=NULL,keepfile=NULL,phenofile=NULL,saveCounts=FALSE)
{
################
#get start time
start_time=Sys.time()
...
if(!is.null(pgenstem))
{
if(system.file(package="pgenlibr")=="")
{return(paste0("Error, please first install the R library pgenlibr by running install.packages(\"pgenlibr\") (if copying this command, you should remove the backslashes manually)"))}
...
################
#open genotypes file and check headers, get some indexes / allocate buffer
